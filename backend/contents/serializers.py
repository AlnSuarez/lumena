...
class MonthlyRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'client', 'client_details', 'assigned_to', 'assigned_to_details', 'qa_assigned_to', 'qa_assigned_to_details', 'month', 'request_type', 'status', 'notes', 'content_text', 'ai_caption', 'feedback', 'created_at', 'updated_at', 'history']
